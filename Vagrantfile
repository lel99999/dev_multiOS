...
# end
  ...
  config.vm.define "multiOS" do |multiOS|
    multiOS.vm.box = "RH7.5_baserepo"
    multiOS.vm.hostname = "multiOS"
    multiOS.vm.network "private_network", ip: "192.168.60.110"
    multiOS.vm.provision "shell", :inline => "sudo echo '192.168.60.110 multiOS.local multiOS' >> /etc/hosts"
    multiOS.vm.provision "ansible" do |ansible|
      ansible.playbook = "deploy_multiOS.yml"
#     ansible.playbook = "deploy_multiOS.yml"
